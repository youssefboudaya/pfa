package tn.esprit.employe.services;
...
import tn.esprit.employe.entities.Contrat;
...
import tn.esprit.employe.interfaces.EmployeServiceRemote;
...
//	}
	...
	public List<String> getAllEmployeNamesJPQL() {
		...
		for(Employe employe : employes){
			employeNames.add(employe.getName());
		}
